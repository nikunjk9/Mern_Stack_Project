...
const Doctors = () => {
  ...
  {/* Created the array to store the data of doctor as there are various categories of doctor so it will be created using this array */}
  ...
  {/*Arrow funtion: check speciality of each doctor and add them in their categories */}
  const applyFilter = () => {
    if (speciality) {
